					...
					<div class="article-content-wrap">
						...
						<div class="post-header">
							...
							<?php if(!($masonry_type == 'classic_enhanced' && $using_masonry == true)) { ?>
								...
								<?php comments_number( __('', NECTAR_THEME_NAME), __('One Comment ', NECTAR_THEME_NAME), __('% Comments', NECTAR_THEME_NAME) ); ?></a></span>
							<?php } ?>
						</div><!--/post-header-->
					<?php
				...
				<?php global $options;
					if( $options['display_tags'] == true ){
						...
						if( is_single() && has_tag() ) {
							...
							echo '<div class="bp-button"><a href="https://businesspartner.trueprofile.io/lp/1" target="_blank">Become a Business Partner</a></div>';
