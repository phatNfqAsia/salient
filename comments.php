...
$comment_label = ($form_style == 'minimal') ? '<label for="comment"> Your comment <span class="required">*</span></label>' : null;
$args = array(
  'id_form'           => 'commentform',
  'id_submit'         => 'submit',
  'title_reply'       => __( 'Comment', NECTAR_THEME_NAME ),
  ...
  'comment_field' =>  '<div class="row"><div class="col span_12"> <label for="comment"> Your comment <span class="required">*</span></label> <textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" required></textarea></div></div>',
  ...
  'fields' => apply_filters( 'comment_form_default_fields', array(
    ...
    'first_name' =>
      ...
      '<label for="first_name">' . __( 'First name', NECTAR_THEME_NAME ) .
      ' <span class="required">*</span></label> ' .
      '<input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) .
      '" size="30" required /></div>',

    'last_name' =>
      '<div class="col span_4"><label for="last_name">' . __( 'Last name', NECTAR_THEME_NAME ) .
      ' <span class="required">*</span></label>' .
    ...
    'email' =>
      ...
      __( 'Email', NECTAR_THEME_NAME ) . '<span class="required">*</span>' . '</label>' .
